...
If you are using the older ant build process, it is no longer officially supported, but you can use the \char`\"{}android-\/project-\/ant\char`\"{} directory as a template.\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md0}{}\doxysection{Requirements}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md0}
...
Minimum API level supported by SDL\+: 16 (Android 4.\+1)\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md1}{}\doxysection{How the port works}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md1}
...
The Java code loads your game code, the SDL shared library, and dispatches to native functions implemented in the SDL library\+: src/core/android/\+SDL\+\_\+android.\+c\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md2}{}\doxysection{Building an app}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md2}
...
\end{DoxyVerb}
\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md3}{}\doxysection{Customizing your application name}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md3}
...
------------------------------------------
\end{DoxyVerb}
 Then replace \char`\"{}\+SDLActivity\char`\"{} in Android\+Manifest.\+xml with the name of your class, .e.\+g. \char`\"{}\+My\+Game\char`\"{}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md4}{}\doxysection{Customizing your application icon}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md4}
Conceptually changing your icon is just replacing the \char`\"{}ic\+\_\+launcher.\+png\char`\"{} files in the drawable directories under the res directory. There are several directories for different screen sizes.\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md5}{}\doxysection{Loading assets}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md5}
Any files you put in the \char`\"{}app/src/main/assets\char`\"{} directory of your project directory will get bundled into the application package and you can load them using the standard functions in SDL\+\_\+rwops.\+h.
...
See SDL\+\_\+system.\+h for more details on these functions.
...
\href{http://ponystyle.com/blog/2010/03/26/dealing-with-asset-compression-in-android-apps/}{\texttt{ http\+://ponystyle.\+com/blog/2010/03/26/dealing-\/with-\/asset-\/compression-\/in-\/android-\/apps/}}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md6}{}\doxysection{Pause / Resume behaviour}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md6}
...
\end{DoxyItemize}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md7}{}\doxysection{Mouse / Touch events}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md7}
In some case, SDL generates synthetic mouse (resp. touch) events for touch (resp. mouse) devices. To enable/disable this behavior, see SDL\+\_\+hints.\+h\+:
\begin{DoxyItemize}
\item SDL\+\_\+\+HINT\+\_\+\+TOUCH\+\_\+\+MOUSE\+\_\+\+EVENTS
\item SDL\+\_\+\+HINT\+\_\+\+MOUSE\+\_\+\+TOUCH\+\_\+\+EVENTS
\end{DoxyItemize}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md8}{}\doxysection{Misc}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md8}
For some device, it appears to works better setting explicitly GL attributes before creating a window\+: SDL\+\_\+\+GL\+\_\+\+Set\+Attribute(\+SDL\+\_\+\+GL\+\_\+\+RED\+\_\+\+SIZE, 5); SDL\+\_\+\+GL\+\_\+\+Set\+Attribute(\+SDL\+\_\+\+GL\+\_\+\+GREEN\+\_\+\+SIZE, 6); SDL\+\_\+\+GL\+\_\+\+Set\+Attribute(\+SDL\+\_\+\+GL\+\_\+\+BLUE\+\_\+\+SIZE, 5);\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md9}{}\doxysection{Threads and the Java VM}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md9}
...
see\+: \href{https://developer.android.com/training/articles/perf-jni\#faq:-why-didnt-findclass-find-my-class}{\texttt{ https\+://developer.\+android.\+com/training/articles/perf-\/jni\#faq\+:-\/why-\/didnt-\/findclass-\/find-\/my-\/class}}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md10}{}\doxysection{Using STL}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md10}
...
\end{DoxyVerb}
 For more information go here\+: \href{https://developer.android.com/ndk/guides/cpp-support}{\texttt{ https\+://developer.\+android.\+com/ndk/guides/cpp-\/support}}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md11}{}\doxysection{Using the emulator}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md11}
...
Notice that this software emulator is incredibly slow and needs a lot of disk space. Using a real device works better.\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md12}{}\doxysection{Troubleshooting}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md12}
...
\end{DoxyVerb}
\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md13}{}\doxysection{Memory debugging}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md13}
...
\end{DoxyVerb}
\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md14}{}\doxysection{Graphics debugging}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md14}
...
The Tegra Graphics Debugger is available from NVidia here\+: \href{https://developer.nvidia.com/tegra-graphics-debugger}{\texttt{ https\+://developer.\+nvidia.\+com/tegra-\/graphics-\/debugger}}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md15}{}\doxysection{Why is API level 16 the minimum required?}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md15}
The latest NDK toolchain doesn\textquotesingle{}t support targeting earlier than API level 16. As of this writing, according to \href{https://developer.android.com/about/dashboards/index.html}{\texttt{ https\+://developer.\+android.\+com/about/dashboards/index.\+html}} about 99\% of the Android devices accessing Google Play support API level 16 or higher (January 2018).\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md16}{}\doxysection{A note regarding the use of the \char`\"{}dirty rectangles\char`\"{} rendering technique}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md16}
...
Reference\+: \href{http://www.khronos.org/registry/egl/specs/EGLTechNote0001.html}{\texttt{ http\+://www.\+khronos.\+org/registry/egl/specs/\+EGLTech\+Note0001.\+html}}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md17}{}\doxysection{Ending your application}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md17}
Two legitimate ways\+:


\begin{DoxyItemize}
\item return from your \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}} function. Java side will automatically terminate the Activity by calling Activity.\+finish().
...
NB\+: \char`\"{}\+Back button\char`\"{} can be handled as a SDL\+\_\+\+KEYDOWN/\+UP events, with Keycode SDLK\+\_\+\+AC\+\_\+\+BACK, for any purpose.\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md18}{}\doxysection{Known issues}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_android_autotoc_md18}
