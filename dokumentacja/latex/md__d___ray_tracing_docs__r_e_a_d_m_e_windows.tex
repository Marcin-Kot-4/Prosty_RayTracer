\DoxyHorRuler{0}
 \hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_windows_autotoc_md121}{}\doxysection{Open\+GL ES 2.\+x support}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_windows_autotoc_md121}
...
\end{DoxyVerb}
 \hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_windows_autotoc_md122}{}\doxysection{Vulkan Surface Support}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_windows_autotoc_md122}
Support for creating Vulkan surfaces is configured on by default. To disable it change the value of {\ttfamily SDL\+\_\+\+VIDEO\+\_\+\+VULKAN} to 0 in {\ttfamily SDL\+\_\+config\+\_\+windows.\+h}. You must install the \href{https://www.lunarg.com/vulkan-sdk/}{\texttt{ Vulkan SDK}} in order to use Vulkan graphics in your application. 