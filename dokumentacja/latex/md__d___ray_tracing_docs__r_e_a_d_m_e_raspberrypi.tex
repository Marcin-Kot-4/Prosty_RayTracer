...
Raspbian (other Linux distros may work as well).\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md93}{}\doxysection{Features}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md93}
...
\end{DoxyItemize}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md94}{}\doxysection{Raspbian Build Dependencies}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md94}
...
sudo apt-\/get install libraspberrypi0 libraspberrypi-\/bin libraspberrypi-\/dev\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md95}{}\doxysection{NEON}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md95}
If your Pi has NEON support, make sure you add -\/mfpu=neon to your CFLAGS so that SDL will select some otherwise-\/disabled highly-\/optimized code. The original Pi units don\textquotesingle{}t have NEON, the Pi2 probably does, and the Pi3 definitely does.\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md96}{}\doxysection{Cross compiling from x86 Linux}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md96}
...
\end{DoxyVerb}
 \hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md97}{}\doxysection{Apps don\textquotesingle{}t work or poor video/audio performance}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md97}
...
Using a fixed gpu\+\_\+mem=128 is the best option (specially if you updated the firmware, using CMA probably won\textquotesingle{}t work, at least it\textquotesingle{}s the current case).\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md98}{}\doxysection{No input}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md98}
Make sure you belong to the \char`\"{}input\char`\"{} group. \begin{DoxyVerb}sudo usermod -aG input `whoami`
\end{DoxyVerb}
 \hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md99}{}\doxysection{No HDMI Audio}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md99}
If you notice that ALSA works but there\textquotesingle{}s no audio over HDMI, try adding\+: \begin{DoxyVerb}hdmi_drive=2
\end{DoxyVerb}
 to your config.\+txt file and reboot.

Reference\+: \href{http://www.raspberrypi.org/phpBB3/viewtopic.php?t=5062}{\texttt{ http\+://www.\+raspberrypi.\+org/php\+BB3/viewtopic.\+php?t=5062}}\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md100}{}\doxysection{Text Input API support}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md100}
...
\end{DoxyVerb}
\hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md101}{}\doxysection{Open\+GL problems}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md101}
...
\end{DoxyVerb}
 \hypertarget{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md102}{}\doxysection{Notes}\label{md__d___ray_tracing_docs__r_e_a_d_m_e_raspberrypi_autotoc_md102}
